  ...
  return (
    <div className="mobile-container">
      ...
      <div className="mobile-page">
        ...
        <div className="egg-incubator mb-6">
        ...
        <div className="mobile-card mb-6">
          <div className="flex items-center justify-between mb-4">
            <input
              ...
              className="mobile-input text-center text-2xl font-bold"
              min="1"
              max="100"
            />
            <span className="text-muted-foreground text-lg">WLD</span>
          </div>
          <div className="text-sm text-muted-foreground mb-4">
            Min: 1 WLD, Max: 100 WLD.
          </div>
          <button 
            className="btn-figma-primary text-sm"
